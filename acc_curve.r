...
make_raref_plot_richness <- function(acc_curve, plot_title, taxon_level = "Taxa") {
  ...
  plot_path <- paste(HOME_, "ISPRA_20152017_Analysis/Plots/Rich_levels", sep = "/")
  ggsave(paste(plot_path, plot_title, sep = "/"), grid.arrange(p1, p2, ncol = 2, widths = c(1, 1), heights = c(1)), width = 25, height = 10)
}


make_raref_plot_richness(acc_curve.size_based, "acc_curve_all_regions_only_species.png", "Species")
